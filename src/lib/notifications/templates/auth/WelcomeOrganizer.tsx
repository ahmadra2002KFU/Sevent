// A2 — welcome email for newly verified organizer accounts.
...
import { strings } from "./WelcomeOrganizer.strings";

export type WelcomeOrganizerProps = {
  locale: Locale;
  recipientName?: string | null;
  appUrl?: string;
};

export default function WelcomeOrganizer({
  locale,
  recipientName,
  appUrl = "http://localhost:3000",
}: WelcomeOrganizerProps) {
  ...
  const ctaUrl = `${appUrl}/organizer/events/new`;
