...
export const strings = {
  ...
  ar: {
    ...
    body: "حسابك جاهز. بصفتك منظّمًا للفعاليات يمكنك نشر طلبات عروض الأسعار وحجز مورّدين سعوديين موثوقين في إدارة الفعاليات والإنتاج الإعلامي والضيافة وأكثر — في مكان واحد.",
