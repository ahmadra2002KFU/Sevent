...
export const strings = {
  en: {
    ...
    body: "Your account is ready. As an organizer you can post event RFQs and book vetted Saudi suppliers across event management, media production, hospitality and more, all in one place.",
  ...
  ar: {
    ...
    body: "حسابك جاهز. بصفتك منظّمًا للفعاليات يمكنك نشر طلبات عروض الأسعار وحجز مورّدين سعوديين موثوقين في إدارة الفعاليات والإنتاج الإعلامي والضيافة وأكثر، كل ذلك في مكان واحد.",
