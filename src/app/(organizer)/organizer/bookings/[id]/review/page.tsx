...
import { RATING_DIMENSIONS } from "@/lib/domain/reviews";
...
export default async function OrganizerReviewPage({ params }: PageProps) {
  ...
  // Wrong role (the supplier-owner clicking the organizer URL by mistake)
  if (ctx.ok && ctx.role !== "organizer") {
    redirect(`/supplier/bookings/${id}/review`);
  }
