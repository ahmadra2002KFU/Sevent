...
/**
 * Responsive masonry-ish photo grid. First tile spans 2 columns and 2 rows on
 * large screens so the portfolio has a clear focal image. Every tile opens a
 * full-screen lightbox via shadcn Dialog.
 *
        ...
        {items.map((item, index) => (
          <li
            ...
            className={cn(
              ...
              // First tile takes the stage on lg+
