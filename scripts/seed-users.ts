...
const SUPPLIERS: SupplierSpec[] = [
  // Riyadh (12)
  { business_name: "Riyadh Royal Ballroom", legal_type: "company", base_city: "Riyadh", subcategory_slug: "venue-ballroom", languages: ["ar","en"], capacity: 600, concurrent_event_limit: 2, cr_number: "1010111111", bio: "Ballroom venue in North Riyadh with in-house catering partnerships.", package_prices_sar: [35000, 55000], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "KAFD Conference Suites", legal_type: "company", base_city: "Riyadh", subcategory_slug: "venue-conference", languages: ["ar","en"], capacity: 250, concurrent_event_limit: 3, cr_number: "1010333333", bio: "Premium conference halls in KAFD with full AV.", package_prices_sar: [18000, 26000], package_units: ["day","day"], min_qty: [1,1] },
  { business_name: "Sufra Catering Riyadh", legal_type: "company", base_city: "Riyadh", subcategory_slug: "catering-buffet", languages: ["ar","en"], capacity: 1000, concurrent_event_limit: 2, cr_number: "1010444444", bio: "Arabic and international buffet catering.", package_prices_sar: [250, 380], package_units: ["person","person"], min_qty: [50,100] },
  ...
  { business_name: "Qahwat Al Najd", legal_type: "freelancer", base_city: "Riyadh", subcategory_slug: "catering-coffee", languages: ["ar"], capacity: 500, concurrent_event_limit: 2, national_id: "1098765431", bio: "Traditional Saudi coffee + dessert service.", package_prices_sar: [3200, 5500], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "Capital Corporate Photo", legal_type: "company", base_city: "Riyadh", subcategory_slug: "photo-corporate", languages: ["en","ar"], capacity: 1, concurrent_event_limit: 2, cr_number: "1010777777", bio: "Corporate event photography.", package_prices_sar: [6500, 11500], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "Florals of Najd", legal_type: "freelancer", base_city: "Riyadh", subcategory_slug: "decor-florals", languages: ["ar","en"], capacity: 1, concurrent_event_limit: 2, national_id: "1234567890", bio: "Floral designers specializing in modern Arabian arrangements.", package_prices_sar: [4500, 9500], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "StageWorks Riyadh", legal_type: "company", base_city: "Riyadh", subcategory_slug: "av-sound", languages: ["en","ar"], capacity: 2000, concurrent_event_limit: 2, cr_number: "1010999999", bio: "Sound reinforcement, mics, and mixing.", package_prices_sar: [9500, 18000], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "Al Hamra Ballroom", legal_type: "company", base_city: "Jeddah", subcategory_slug: "venue-ballroom", languages: ["ar","en"], capacity: 800, concurrent_event_limit: 2, cr_number: "4030222222", bio: "Grand ballroom in Al Hamra district with parking for 300.", package_prices_sar: [38000, 62000], package_units: ["event","event"], min_qty: [1,1] },
  { business_name: "Red Sea Conference Centre", legal_type: "company", base_city: "Jeddah", subcategory_slug: "venue-conference", languages: ["ar","en"], capacity: 300, concurrent_event_limit: 2, cr_number: "4030333333", bio: "Waterfront conference halls with breakout rooms.", package_prices_sar: [16000, 24000], package_units: ["day","day"], min_qty: [1,1] },
  { business_name: "Hijazi Feast Catering", legal_type: "company", base_city: "Jeddah", subcategory_slug: "catering-buffet", languages: ["ar","en"], capacity: 1200, concurrent_event_limit: 2, cr_number: "4030444444", bio: "Authentic Hijazi buffet with live stations.", package_prices_sar: [240, 360], package_units: ["person","person"], min_qty: [60,120] },
  ...
  { business_name: "Dessert Trolley Jeddah", legal_type: "freelancer", base_city: "Jeddah", subcategory_slug: "catering-coffee", languages: ["ar"], capacity: 400, concurrent_event_limit: 2, national_id: "1098765432", bio: "Coffee, dates, and dessert service.", package_prices_sar: [2800, 4800], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "Coast Corporate Video", legal_type: "company", base_city: "Jeddah", subcategory_slug: "video-cinematic", languages: ["en","ar"], capacity: 1, concurrent_event_limit: 2, cr_number: "4030777777", bio: "Cinematic event films and highlight reels.", package_prices_sar: [12000, 22000], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "Petal Studio Jeddah", legal_type: "company", base_city: "Jeddah", subcategory_slug: "decor-florals", languages: ["ar","en"], capacity: 1, concurrent_event_limit: 2, cr_number: "4030888888", bio: "Floral design studio with same-day delivery.", package_prices_sar: [5200, 10500], package_units: ["event","event"], min_qty: [1,1] },
  ...
  { business_name: "Coastline Staging", legal_type: "company", base_city: "Jeddah", subcategory_slug: "av-staging", languages: ["en","ar"], capacity: 1500, concurrent_event_limit: 2, cr_number: "4032222222", bio: "Modular staging, trussing, and LED walls.", package_prices_sar: [14000, 26000], package_units: ["event","event"], min_qty: [1,1] },
];
